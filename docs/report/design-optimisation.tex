...
\begin{table}[thb]
	...
	\begin{tabular}{l|l}
		...
		with pointer comparison & 44 seconds \\
	...
	\caption{Execution times of the modelfitting process after making each optimisation.
		...
		The ``pointer comparison'' improvement was not noteworthy enough for a mention in the previous sections,
		but involves using while loops instead of for loops.
